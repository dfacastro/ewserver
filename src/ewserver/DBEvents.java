...
public class DBEvents {
     ...
     * Formato SHORT: {event: {id = ï¿½idxï¿½, nome = ï¿½nomexï¿½, onde = ï¿½ondexï¿½, dinicio = ï¿½dataï¿½, nome_emp = ï¿½nomeEmpï¿½} }
    ...
    /**
     * Procura informaï¿½ï¿½o do evento com o id = ide e retorna a sua informaï¿½ï¿½o detalhada.
     * formato informacao full: 
     * { event: {ide=ï¿½idxï¿½, nome =ï¿½nomexï¿½, desc = ï¿½descxï¿½, onde=ï¿½ondexï¿½, dinicio =ï¿½dinicioxï¿½, dfim = ï¿½dfimxï¿½, contador = ï¿½ï¿½, nome_empresa = ï¿½nomeEmpï¿½}}}
     * @param ide
     * @return
     */
